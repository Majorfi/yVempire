...
function	FAQElement({label, children}: {label: string, children: ReactNode}): ReactElement {
	...
	return (
		<div onClick={onExpand} className={'bg-surface w-full cursor-pointer rounded-lg'}>
			<div className={'text-typo-primary flex flex-row items-center justify-between p-4 font-bold md:p-6'}>
				{label}
				<svg
					width={'24'}
					height={'24'}
					className={`transition-transform${isExpandedAnimation ? '' : '-rotate-90'}`}
					viewBox={'0 0 24 24'}
					fill={'none'}
			...
			<div className={`w-full overflow-hidden transition-max-height duration-500 ${isExpandedAnimation ? 'max-h-96' : 'max-h-0'}`}>
	...
	return (
		<div className={'mt-4 w-full space-y-4 md:mt-6'}>
			<FAQElement label={'What is Bowswap?'}>
				<div className={'text-typo-secondary px-4 pb-4 text-sm font-normal leading-4 md:px-6 md:pb-6'}>
			...
			<FAQElement label={'What are the benefits of using Bowswap?'}>
				<div className={'text-typo-secondary px-4 pb-2 text-sm font-normal leading-4 md:px-6'}>
			...
			<FAQElement label={'Why do I need MEV protection?'}>
				...
				<div className={'text-typo-secondary px-4 pb-4 text-sm font-normal leading-4 md:px-6 md:pb-6'}>
					{'Learn more about '}
					<a href={'https://medium.com/flashbots/frontrunning-the-mev-crisis-40629a613752'} target={'_blank'} rel={'noreferrer'} className={'hover:text-primary-variant font-medium text-primary'}>{'MEV'}</a>
					{'.'}
				</div>
			</FAQElement>
			<FAQElement label={'How to enable MEV protection?'}>
				<div className={'mb-6 px-6'}>
					<div className={'bg-secondary relative overflow-hidden rounded-lg p-4'}>
						<div className={'text-typo-secondary flex w-full flex-row items-center text-sm font-normal leading-4'}>
							...
							<div
								...
								<div
									className={'text-ygray-400 mb-1 ml-2 opacity-0 group-hover:opacity-80'}>
						...
						<div className={'text-typo-secondary flex w-full flex-row items-center text-sm font-normal leading-4'}>
							...
							<div
								...
								<div className={'text-ygray-400 mb-1 ml-2 opacity-0 group-hover:opacity-80'}>
									<svg width={10} height={14} aria-hidden={'true'} focusable={'false'} role={'img'} xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 384 512'}><path fill={'currentColor'} d={'M336 64h-53.88C268.9 26.8 233.7 0 192 0S115.1 26.8 101.9 64H48C21.5 64 0 85.48 0 112v352C0 490.5 21.5 512 48 512h288c26.5 0 48-21.48 48-48v-352C384 85.48 362.5 64 336 64zM192 64c17.67 0 32 14.33 32 32c0 17.67-14.33 32-32 32S160 113.7 160 96C160 78.33 174.3 64 192 64zM272 224h-160C103.2 224 96 216.8 96 208C96 199.2 103.2 192 112 192h160C280.8 192 288 199.2 288 208S280.8 224 272 224z'}></path></svg>
								</div>
							</div>
						</div>
				...
				<div className={'text-typo-secondary px-4 pb-4 text-sm font-normal leading-4 md:px-6 md:pb-6'}>
					...
					<a href={'https://docs.flashbots.net/flashbots-protect/rpc/quick-start/'} target={'_blank'} rel={'noreferrer'} className={'hover:text-primary-variant font-medium text-primary'}>{'instructions'}</a>
					{'.'}
				</div>
			</FAQElement>
